 ...
 */
public class JDCadMarca extends javax.swing.JDialog {
     ...
     */
    public JDCadMarca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        lookandfell();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDCadMarca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDCadMarca dialog = new JDCadMarca(new javax.swing.JFrame(), true);
